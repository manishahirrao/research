    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start">
          ...
          <div className="ml-4">
            ...
            <a
              ...
              className="text-body-md text-brand-red hover:text-brand-red-dark transition-colors break-all"
            >
              {contactInfo.email}
            </a>
          </div>
        ...
        <div className="flex items-start">
          ...
          <div className="ml-4">
            <h3 className="text-sm font-semibold text-neutral-black mb-2">Follow Us</h3>
