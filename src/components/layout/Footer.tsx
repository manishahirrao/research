          ...
          <div>
            ...
            <div className="mt-6 flex items-center space-x-4">
              <a
                ...
                className="text-neutral-muted hover:text-brand-red transition-colors"
                aria-label="LinkedIn"
              >
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="text-sm text-neutral-muted hover:text-brand-red transition-colors flex items-start"
                >
                  <svg
