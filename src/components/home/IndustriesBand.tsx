      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 mb-12">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-body-lg text-neutral-light">
            Deep domain expertise across 16 key industries, delivering insights that drive strategic
            advantage.
          </p>
        </div>
      </div>

      {/* Desktop: Auto-rotating 2 rows */}
      <div className="hidden md:block space-y-6">
        {/* First Row - Scrolling Left to Right */}
        <div className="relative overflow-hidden">
          <div className="flex gap-6 animate-scroll-left">
            {[...industries.slice(0, 8), ...industries.slice(0, 8)].map((industry, index) => (
              <div
                key={index}
                className="flex-shrink-0 w-64 flex flex-col items-center justify-center p-6 rounded-card bg-neutral-mid/20 hover:bg-brand-red/10 border border-neutral-mid/30 hover:border-brand-red/50 transition-all duration-300"
              >
        ...
        <div className="relative overflow-hidden">
          <div className="flex gap-6 animate-scroll-right">
            {[...industries.slice(8, 16), ...industries.slice(8, 16)].map((industry, index) => (
              <div
                key={index}
                className="flex-shrink-0 w-64 flex flex-col items-center justify-center p-6 rounded-card bg-neutral-mid/20 hover:bg-brand-red/10 border border-neutral-mid/30 hover:border-brand-red/50 transition-all duration-300"
              >
