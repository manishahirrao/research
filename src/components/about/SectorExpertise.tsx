...
const sectors: Sector[] = [
  ...
  },
  {
    ...
    capability:
      'Trend forecasting, brand perception, collection testing, and sustainability research.',
  },
  {
    icon: (
      <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    name: 'Machine Tools',
    capability:
      'Technology adoption, purchase decision-making, product development, and market analysis.',
  },
  {
    icon: (
      <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    name: 'Aerospace',
    capability:
      'Technology adoption trends, supplier evaluation, market opportunities, and competitive intelligence.',
  },
  {
    icon: (
      <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    name: 'Food & Beverage',
    capability:
      'Taste testing, product concept validation, health perception, and sustainability preferences.',
  },
  {
    icon: (
      <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    capability:
      'Product performance testing, athlete segmentation, brand positioning, and innovation validation.',
  },
  {
    icon: (
      <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    capability:
      'Purchase criteria mapping, technology adoption, customer satisfaction, and market sizing.',
  },
  {
    icon: (
      <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    name: 'Furniture',
    capability:
      'Design preference research, product concept testing, material preferences, and pricing strategy.',
  },
  {
    icon: (
      <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    name: 'Oil & Gas',
    capability:
      'Technology adoption, stakeholder perception, market dynamics, and energy transition research.',
  },
  {
    icon: (
      <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    name: 'Plastics',
    capability:
      'Material preferences, sustainability attitudes, recycling adoption, and regulatory impact.',
  },
  {
    icon: (
      <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    name: 'Ceramics & Glass',
    capability:
      'Application research, product innovation, technical performance, and market positioning.',
  },
];
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-body-lg text-neutral-mid">
            Deep domain knowledge across 16 key industries, delivering insights that drive
            strategic advantage.
          </p>
        </div>
